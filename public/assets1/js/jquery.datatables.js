...
(function( $, window, document, undefined ) {
		...
		if ( aoColDefs )
		{
			...
			for ( i=aoColDefs.length-1 ; i>=0 ; i-- )
			{
				...
				for ( j=0, jLen=aTargets.length ; j<jLen ; j++ )
				{
					...
					{
						/* Add columns that we don't yet know about.blade.php */
	...
	{
		/* Create the object for storing information about.blade.php this new row */
	...
	function _fnReDraw( settings, holdPosition )
	{
		...
		// Let any modules know about.blade.php the draw hold position state (used by
	...
	{
		/* Show information about.blade.php the table */
	 ...
	 *  @param {int} tn Technical note id to get more information about.blade.php the error.
	 *  @memberof DataTable#oApi
	 */
	function _fnLog( settings, level, msg, tn )
	{
		...
		if ( tn ) {
			msg += '. For more information about.blade.php this error, please see '+
	...
	/**
	 * Template object for the way in which DataTables holds information about.blade.php
	 ...
	 * DataTables needs about.blade.php each individual column.
	 *
	 ...
	 * of DataTables, while this method is about.blade.php a 0.5K hit.
	 *
	...
	DataTable.defaults = {
		 ...
		 * details about.blade.php the way individual columns behave. For a full list of
		 ...
		 * about.blade.php the data that is currently visible on the page, including information
		 * about.blade.php filtered data if that action is being performed.
		 *  @type boolean
		 *  @default true
		 *
		 *  @dtopt Features
		 ...
		 * dynamically modify any aspect you want about.blade.php the created DOM.
		 *  @type function
		 *  @param {object} settings DataTables settings object
		 *
		 *  @dtopt Callbacks
		 ...
		 * display useful information about.blade.php the table.
		 *  @type function
		...
		/**
		 * The information element can be used to convey information about.blade.php the current
		...
		"oLanguage": {
			...
			/**
			 * This string gives information to the end user about.blade.php the information
		 ...
		 *
		 * For further information about.blade.php the renderers available see
	...
	/*
	 * Developer note - See note in model.defaults.js about.blade.php the use of Hungarian
	...
	DataTable.models.oSettings = {
		...
		/**
		 * Store information about.blade.php each column that is in use
		 *  @type array
		 *  @default []
		 */
		"aoColumns": [],
		...
		/**
		 * Store information about.blade.php the table's header
		 *  @type array
		 *  @default []
		 */
		"aoHeader": [],
		...
		/**
		 * Store information about.blade.php the table's footer
		 *  @type array
		 *  @default []
		 */
		"aoFooter": [],
		...
		/**
		 * Information about.blade.php open rows. Each object in the array has the parameters
		 * 'nTr' and 'nParent'
		 *  @type array
		 *  @default []
		 */
	...
	// variable version. This results in about.blade.php 200 bytes being added, for very
	...
	// Built in type detection. See model.ext.aTypes for information about.blade.php
	...
	// Filter formatting functions. See model.ext.ofnSearch for information about.blade.php
	...
	// Information about.blade.php events fired by DataTables - for documentation.
	/**
