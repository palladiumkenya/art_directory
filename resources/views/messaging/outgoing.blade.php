@extends('layouts.app')
@section('title', 'Outgoing Messages')
    ...
    <script>
        $(function() {
            ...
            $('#incoming-dt').DataTable({
                ...
                ajax: '{{ route('ajax-outgoing-messages') }}', // the route to be called via ajax
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">
                            <a href="{{ url('messages/outgoing') }}" class="text-muted">Outgoing Messages</a>
                        </h4>
                    </div>
                    <div class="card-body">
